...
VersionPress 4.0 introduces support for WordPress plugins via [plugin definitions](https://github.com/versionpress/versionpress/blob/4.0-alpha1/docs/Plugin-Support.md). It also includes Slack-like search, staging visualization and initial support for Composer workflows.
