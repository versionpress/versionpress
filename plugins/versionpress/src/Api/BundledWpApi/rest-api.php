...
if (!class_exists('WP_REST_Request')) {
    require_once(__DIR__ . '/rest-api/class-wp-rest-request.php');
}

if (!class_exists('WP_HTTP_Response')) {
    require_once(__DIR__ . '/class-wp-http-response.php');
}

if (!class_exists('WP_REST_Response')) {
    require_once(__DIR__ . '/rest-api/class-wp-rest-response.php');
}

if (!class_exists('WP_REST_Server')) {
    require_once(__DIR__ . '/rest-api/class-wp-rest-server.php');
}
...
function vp_rest_api_maybe_flush_rewrites() {
    ...
    if ( empty( $version ) || REST_API_VERSION !== $version ) {
        flush_rewrite_rules();
        update_option( 'vp_rest_api_plugin_version', REST_API_VERSION );
    }
...
if (!defined('REST_API_VERSION')) {
    ...
    require_once(__DIR__ . '/default-filters.php');
