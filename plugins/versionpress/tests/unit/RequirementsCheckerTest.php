...
class RequirementsCheckerTest extends \PHPUnit_Framework_TestCase {
    ...
    public function gitCheckFailsForGit_1_8_0() {
        $this->assertFalse(RequirementsChecker::gitMatchesMinimumRequiredVersion("git version 1.8.0", "1.9"));
    }
    ...
    public function gitCheckPassesForGit_1_9_0() {
        $this->assertTrue(RequirementsChecker::gitMatchesMinimumRequiredVersion("git version 1.9.0", "1.9"));
    }
    ...
    public function gitCheckPassesForGit_2_2_0() {
        $this->assertTrue(RequirementsChecker::gitMatchesMinimumRequiredVersion("git version 2.2.0", "1.9"));
    }
