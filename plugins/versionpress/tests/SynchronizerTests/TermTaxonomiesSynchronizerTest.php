...
class TermTaxonomiesSynchronizerTest extends SynchronizerTestCase {
    ...
    protected function setUp() {
        ...
        $this->synchronizer = new TermTaxonomiesSynchronizer($this->storage, self::$database, self::$schemaInfo->getEntityInfo('term_taxonomy') ,self::$schemaInfo, self::$vpidRepository, self::$urlReplacer, self::$shortcodesReplacer);
    ...
    public function synchronizerAddsTwoTermTaxonomiesWithTheSameTaxonomy() {
        ...
        $termsSynchronizer = new TermsSynchronizer($this->termStorage, self::$database, self::$schemaInfo->getEntityInfo('term') ,self::$schemaInfo, self::$vpidRepository, self::$urlReplacer, self::$shortcodesReplacer);
        $termTaxonomiesSynchronizer = new TermTaxonomiesSynchronizer($this->storage, self::$database, self::$schemaInfo->getEntityInfo('term_taxonomy') ,self::$schemaInfo, self::$vpidRepository, self::$urlReplacer, self::$shortcodesReplacer);
