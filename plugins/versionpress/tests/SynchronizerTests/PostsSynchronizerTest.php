...
class PostsSynchronizerTest extends SynchronizerTestCase {
    ...
    protected function setUp() {
        ...
        $this->synchronizer = new PostsSynchronizer($this->storage, self::$database, self::$schemaInfo->getEntityInfo('post') ,self::$schemaInfo, self::$vpidRepository, self::$urlReplacer, self::$shortcodesReplacer);
        ...
        $this->termTaxonomiesSynchronizer = new TermTaxonomiesSynchronizer($this->termTaxonomyStorage, self::$database, self::$schemaInfo->getEntityInfo('term_taxonomy') ,self::$schemaInfo, self::$vpidRepository, self::$urlReplacer, self::$shortcodesReplacer);
    }
