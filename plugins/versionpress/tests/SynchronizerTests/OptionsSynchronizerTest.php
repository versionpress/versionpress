...
class OptionsSynchronizerTest extends SynchronizerTestCase {
    ...
    protected function setUp() {
        ...
        $this->synchronizer = new OptionsSynchronizer($this->storage, self::$database, self::$schemaInfo->getEntityInfo('option') ,self::$schemaInfo, self::$vpidRepository, self::$urlReplacer, self::$shortcodesReplacer);
